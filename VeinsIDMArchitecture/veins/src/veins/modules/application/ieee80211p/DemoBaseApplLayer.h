...
protected:
    ...
    virtual void onBSM(DemoSafetyMessage* bsm){}; // on receiving a bsm, the rsu will create an asl packet consisting of the appropriate asl speed that the car should follow
    // only if the car is past the induction loop position
