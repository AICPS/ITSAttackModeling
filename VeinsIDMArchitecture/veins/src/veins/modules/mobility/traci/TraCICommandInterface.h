...
public:
    ...
    void setTotalWaitTime(double value){
         totalAccWaitTime = value;
         return;
     }

    double getTotalWaitTime(){
         return  totalAccWaitTime;
     }
    ...
    bool removeVehicle(std::string vehicleId);
    ...
    public:
        ...
        double getDeccel();
        double getSpeed();
        std::pair<std::string, double> getLeader(double lookAhead);
